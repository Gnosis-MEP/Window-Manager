...
But in order to make the automatic docker image build work, you'll need to set the `SIT_PYPI_USER` and `SIT_PYPI_PASS` variables in the Gitlab CI setting page: [Window Manager CI Setting Page](https://gitlab.insight-centre.org/sit/mps/felipe-phd/window-manager/settings/ci_cd).
